          ...
          setTimeout(async () => {
            if (res.session.payment_status === 'paid') {
              ...
              for (const item of items) {
                ...
                if (
                  priceId === this.videoSectionPriceIds.monthly ||
                  priceId === this.videoSectionPriceIds.yearly
                ) {
                  planOptions.videoSection = quantity;
                }
                // Check for who viewed profile price
                else if (
                  priceId === this.whoViewedProfilePriceIds.monthly ||
                  priceId === this.whoViewedProfilePriceIds.yearly
                ) {
                  planOptions.whoViewedProfile = true;
                }
                // Check for value bundle price
                else if (
                  priceId === this.valueBundlePriceIds.monthly ||
                  priceId === this.valueBundlePriceIds.yearly
                ) {
